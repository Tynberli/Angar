    ...
    return (
        <div data-tabs-target="insulation-no"
            ...
            <div className="relative ">
                ...
                <div className="relative">
                    <Image width={1757} height={874} src="/img-8-2.webp" alt=""
                           className="relative pad:left-[-20%] w-100%  "/>
                    <div
                        className="bg-[#1A81FA] rounded-[50%] p-[6px] max-w-fit absolute top-[20px] left-[60%] hidden mobil:block">
                        <div className="bg-[#FFFFFF] rounded-[50%] p-[10px_13.7px_9px_12px]">
                            <svg width="7"
                ...
                <div className="bg-[#1A81FA] absolute rounded-[50%] p-[6px] max-w-fit top-[300px] left-[200px] pad:top-[150px] pad:left-[100px]
                                     netbook:top-[200px] netbook:left-[230px] mobil:hidden  "
                ...
                <div className="bg-[#1A81FA] absolute  rounded-[50%] p-[6px] max-w-fit top-[180px] left-[700px]
                                     netbook:left-[330px] netbook:top-[30px] pad:left-[15%] pad:top-[30px]  mobil:hidden  "
                    /* style="transition: all 1.5s;" */>
                    <div className="bg-[#ffffff] h-[12px] w-[12px] rounded-[50%] relative ">
...
const Tab2 = () => {
    return (
        <div data-tabs-target="insulation-yes"
            ...
            <div className="relative ">
                <div
                    className=" flex-col gap-[10px] hidden mobil:flex  ">
                    <div className="bg-[#ffffff] rounded-[5px] p-[25px_40px_35px_30px] ">
                        <p className="font-bold text-[20px] leading-[26px] ">Профлист</p>
                        <p className="max-w-[283px] mt-[10px]">
                            Описание материала в несколько строк, например модификация стали
                ...
                <div className="relative">
                    <Image width={1757} height={874} src="/img-8.webp" alt=""
                           className="relative pad:left-[-20%] w-100%  "/>
                    <div
                        className="bg-[#1A81FA] rounded-[50%] p-[6px] max-w-fit absolute top-[20px] left-[60%] hidden mobil:block">
                        <div className="bg-[#FFFFFF] rounded-[50%] p-[10px_13.7px_9px_12px]">
...
const Warming = () => {
    ...
    return (
        <section id="warming" className={styles.warming}>
                ...
                <div className={styles.wrapper}>
                    <div className={styles.buttons}>
                        <button onClick={handleTab1}
                                className={activeTab === "tab1" ? "active  text-[#fff] bg-[#1A81FA]" : ""}>Без
                            утепления
                        </button>
                        <button onClick={handleTab2}
                                className={activeTab === "tab2" ? "active text-[#fff] bg-[#1A81FA]" : ""}>С
                            утеплением
                        </button>
                    </div>
                    {activeTab === "tab2" ? <Tab2/> : <Tab1/>}
